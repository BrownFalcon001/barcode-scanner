                      ...
                      <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                          ...
                          <div class="row">
                              ...
                              <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                  <b>Date of Birth</b> <a class="float-right">
                                    <?php
                                    echo substr($row['DATE_OF_BIRTH'], -19,-9);
                                    ?>
                                  </a>
                                </li>
                                <li class="list-group-item">
                                ...
                                <li class="list-group-item">
                                  <b>Medical Catagory</b> <a class="float-right">
                                    <?php
                                    echo $row['MEDICAL_CATEGORY'];
                                    ?>
                                  </a>
                                </li>
                                <li class="list-group-item">
                                  <b>Maratial Status</b> <a class="float-right">
                                    <?php
                            ...
                            <div class="col-lg-6 col-12">
                              <h3 style="text-align: center;"><b>Work Info</b></h3>
                              <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                ...
                                <li class="list-group-item">
                                  <b>Date of Enrollment</b> <a class="float-right">
                                    <?php
                                   echo substr($row['DATE_OF_ENROLLMENT'], -19,-9);
                                    ?>
                                  </a>
                                </li>
                                <li class="list-group-item">
                                  <b>Date of Joining the Unit</b> <a class="float-right">
                                    <?php
                                    echo substr($row['DATE_OF_JOINING_THE_UNIT'], -19,-9);
                                    ?>
                                  </a>
                                </li>
                                <li class="list-group-item">
                                  <b>Date of Getting Present Rank</b> <a class="float-right">
                                    <?php
                                    echo substr($row['DATE_OF_GETTING_PRESENT_RANK'], -19,-9);
                                    ?>
                                  </a>
                                </li>
                                <li class="list-group-item">
                                  <b>Date of Retirement(Probable)</b> <a class="float-right">
                                    <?php
                                    echo substr($row['DATE_OF_RETIREMENT'], -19,-9);
                                    ?>
                                  </a>
                                </li>
                                <li class="list-group-item">
                                  <b>NUMBER OF UNIT MISSION</b> <a class="float-right">
                                    <?php
                                    echo $row['NUMBER_OF_UN_MISSION'];
                                    ?>
                                  </a>
                                </li>
